...
import ImageGallery from "./EditimagesRestaurant";
import {
  Box,
  Grid,
  Button,
...
function Restaurant() {
  ...
  useEffect(() => {
    axios
      .get(`${BACKEND_URL}/test/restaurant/${id}`)
      .then((response) => setHotel(response.data))
      .catch((error) => console.log(error));
    axios
      .get(`${BACKEND_URL}/test/restaurant/images/${id}`)
  ...
  const deleteTour = () => {
    if (hotel) {
      axios
        .delete(`${BACKEND_URL}/test/restaurant/${hotel.id}`)
  ...
  const updateTour = (eventData) => {
    ...
    if (hotel) {
      axios
        .put(`${BACKEND_URL}/test/restaurant/${hotel.id}`, eventData)
        .then((response) => setHotel(response.data))
        .catch((error) => console.log(error));
    }
  };
